...
class PreMatchItem extends StatefulWidget {
	PreMatchModel match;

	PreMatchItem({required this.match});

	@override
	_PreMatchItemState createState() => _PreMatchItemState();
}

class _PreMatchItemState extends State<PreMatchItem> {
	@override
